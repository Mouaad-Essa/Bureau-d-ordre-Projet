...
const DivisionPage = () => {
  ...
  if (!division) {
    return <p>Aucun division trouvé pour cet ID.</p>;
  }
  ...
  return (
    <>
        ...
        <h1 className="text-2xl font-bold mb-4">Détails de la division</h1>
        <div className="space-y-2 w-fit">
            ...
            <p>
              <span className="font-medium">ResponsableId:</span> {division.responsableId}
            </p>
            <p>
              <span className="font-medium">bureauId:</span> {division.bureauId}
            </p>
            <p>
